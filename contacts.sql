...
--
-- Table structure for table `contacts_inquiry`
--

CREATE TABLE `contacts_inquiry` (
...
INSERT INTO `contacts_inquiry` (`id`, `fname`, `lname`, `email`, `subject`, `message`, `created_at`) VALUES
